                    ...
                    {room.map((item, index) => (
                        <div className="col-xl-4" key={index} style={{ marginBottom: "50px", padding: "0px", fontFamily: "unset" }} >
                            <div className=" d-flex flex-column justify-content-center align-items-center">
                                <NavLink to={`/room/${item.room}`} className={activeClass} id="img-link"> 
                                <img style={{ width: "400px", height: "300px", borderRadius: "10px" }} src={item.name}></img>
                                    <p className="detail">DETAIL</p>
                                </NavLink>
                                <div className="d-flex align-items-center">
                                    <strong style={{ fontSize: "20px", paddingRight: "20px" }}>{item.room}</strong>
                                    ...
                                    <div style={{ paddingLeft: "20px" }}>{item.add}</div>
                                </div>
                                <div className="d-flex justify-content-around" style={{ width: "100%", fontSize: "20px" }}>
                                    ...
                                    </svg><div style={{ marginLeft: "10px" }}>{item.people} people</div>
                                    </div>
                                    <div>
                                        <div style={{ color: "Green", fontSize: "20px" }}>{formatCash(item.price)} VND</div>
