...
return (
    ...
    < div classNameName="room-detail" >
        <div classNameName="container">
            ...
            {
                room.filter((item) => (item.room === nameRoom)).map((itemFilter) => {
                    return (
                                    ...
                                    <div className="row" style={{ padding: 0 }}>
                                        <div className="col-lg-9 col-md-12">
                                            <div className="hotel-detail">
                                                <div>
                                                    <h3 className="d-flex" style={{ fontSize: "30px", color: "black", marginLeft: "0px" }}>{itemFilter.room}</h3>
                                                    <hr />
                                                </div>
                                                <div className="product_detail_slider1">
                                                    <img style={{ width: '100%' }} src={itemFilter.name} alt="image" />
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col-lg-3 col-md-12">
                                            <div className="booking_detail_form">
                                                <div className="yemm_top_price">
                                                    <strong style={{ fontSize: "30px", color: "white" }}>{formatCash(itemFilter.price)} VND</strong>
